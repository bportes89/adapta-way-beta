...
const blockchain_entity_1 = require("./entities/blockchain.entity");
...
let BlockchainService = class BlockchainService {
    ...
    async createGenesisBlock() {
        const genesisBlock = new blockchain_entity_1.Block();
    ...
    async createBlock(data) {
        ...
        const newBlock = new blockchain_entity_1.Block();
...
exports.BlockchainService = BlockchainService = __decorate([
    ...
    __param(0, (0, typeorm_1.InjectRepository)(blockchain_entity_1.Block)),
